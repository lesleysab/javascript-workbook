...
//change the strings in the array to a number ^^
//const nums = strNums.map(i => Number(i));
// create a function that finds even numbers
const even = function(num) {
  return num % 2 === 0;
};
//find the even numbers in the array
const newNums = nums.filter(even)
// create a function that adds numbers
const sum = (total, numb) => total + numb
//add all the even numbers in the array
const sumEvens = newNums.reduce(sum)
...
//const newNums = strNums.map(i => Number(i));
//create a function that sums the value and the index
const sumValueIndex = (value, index) => {
  return value + index;
}
//create a new array with the sum of all values and indexes
const nums2 = newNums.map(sumValueIndex)
//find the value of 512 in the array
const find512 = (value) => {
  return value === 512;
}
